...
public class Rat1 extends DifferentialWheels {

  protected final int timeStep = 32;
  protected final double maxSpeed = 300;
  protected final double[] collisionAvoidanceWeights = {0.0,0.0,-0.12,0.0,0.3,0.0,0.0,0.0};
  ...
  public void run() {
    ...
    while (step(timeStep) != -1) {
      ...
      if (distance[4]+distance[5] > 2200||distance[3]+distance[4] >1300|| distance[3]+distance[2] > 3000) {
