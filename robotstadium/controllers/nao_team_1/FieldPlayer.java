...
public class FieldPlayer extends Player {
  ...
  private Motion shootfast,PushUps,PushUps2;
  ...
  public FieldPlayer(int playerID, int teamID) {
    ...
    PushUps  = new Motion("../../motions/FragkoulisMotion.motion");
    PushUps2  = new Motion("../../motions/FragkoulisMotion2.motion");
    shootfast= new Motion("../../motions/Shoot.motion");
